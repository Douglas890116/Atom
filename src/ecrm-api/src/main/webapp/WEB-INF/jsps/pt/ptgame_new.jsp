...
<head>
<meta charset="utf-8">
<%@ include file="pttop.jsp"%>
</head>
<body>
<%@ include file="ptmenu.jsp"%>
<div class="con_cen">
  <ul>
  		<c:forEach var="item" items="${data }" varStatus="i">
  			<li>
		         <div class="pt_img">
		                    <img src="${statics }/pt/images/pt_games/${item.imagename }.png">
		                    <div class="rsp"></div>
		                    <div class="text">
		                      <c:if test="${sessionScope.gametype!='0'}" ><a href="javascript:;" onclick="popup('${item.gamecodeweb }')"><h2>进入游戏</h2></a></c:if>
