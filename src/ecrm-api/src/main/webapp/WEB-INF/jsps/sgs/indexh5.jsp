		...
		<div class="box">
			...
			<div id="doc-oc-demo2" class="am-offcanvas">
			  <div class="am-offcanvas-bar">
			    <div class="am-offcanvas-content">
                    <p><a href="${ctx}/sgsgame/indexh5?stype=">最新游戏</a></p>
                    <p><a href="${ctx}/sgsgame/indexh5?stype=0">老虎机</a></p>
                    <p><a href="${ctx}/sgsgame/indexh5?stype=1">桌面游戏</a></p>
			    </div>
			  </div>
			</div>
		  </div><!--header结束-->
		  ...
		  <ul class="menu">
		  	<c:forEach var="item" items="${data }" varStatus="i">
			     ...
			     <li> <a href="${ctx}/sgsgame/login.do?gamecode=${item.providercode};${item.code }"><img src="${item.iconurl }" width="142" height="142"/> 
			     <p>${item.name }</p> 
			     </a> </li>
