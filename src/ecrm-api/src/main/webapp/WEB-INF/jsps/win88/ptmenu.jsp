    ...
    <div class="top_cen">
      ...
      <div class="nav_l">
         <ul>
         	...
         	<li>
               <a href="${ctx}/win88game/ptnew?stype=" class="col">
            ...
            <li>
               <a href="${ctx}/win88game/ptnew?stype=<%=AESUtil.encrypt("热门游戏") %>" class="col">
            ...
            <li>
               <a href="${ctx}/win88game/ptnew?stype=<%=AESUtil.encrypt("澳门老虎机") %>" class="col">
            ...
            <li>
               <a href="${ctx}/win88game/ptnew?stype=<%=AESUtil.encrypt("漫威老虎机") %>" class="col">
            ...
            <li>
               <a href="${ctx}/win88game/ptnew?stype=<%=AESUtil.encrypt("累积大奖") %>" class="col">
            ...
            <li>
               <a href="${ctx}/win88game/ptnew?stype=<%=AESUtil.encrypt("吃角子老虎机") %>" class="col">
            ...
            <%-- 
            <li>
               <a href="${ctx}/win88game/ptnew?stype=<%=AESUtil.encrypt("街机游戏") %>" class="col">
            ...
            <li>
               <a href="${ctx}/win88game/ptnew?stype=<%=AESUtil.encrypt("乐透刮刮乐") %>" class="col">
