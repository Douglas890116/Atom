...
function calloutLogin(response) {
    ...
    window.location = ('http://cache.download.banner.greenjade88.com/casinoclient.html?language=zh-cn&game=${gametype}');
};
function popup(id)
 {
 	window.open('http://cache.download.banner.greenjade88.com/casinoclient.html?language=zh-cn&game='+id,'Games','width=800,height=600,menubar=no,scrollbars=no,toolbar=no,location=no,directories=no,resizable=no');
 	login(1);
 }
function testGame(id)
 {
 	window.open('http://cache.download.banner.greenjade88.com/casinoclient.html?language=zh-cn&game='+id+'&mode=offline&currency=cny','Games','width=800,height=600,menubar=no,scrollbars=no,toolbar=no,location=no,directories=no,resizable=no') ;
 }
