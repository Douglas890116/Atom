			...
			<div id="doc-oc-demo2" class="am-offcanvas">
			  <div class="am-offcanvas-bar">
			    <div class="am-offcanvas-content">
                    <p><a href="${ctx}/win88game/indexh5?stype=<%=AESUtil.encrypt("最新游戏") %>">最新游戏</a></p>
                    <p><a href="${ctx}/win88game/indexh5?stype=<%=AESUtil.encrypt("热门游戏") %>">热门游戏</a></p>
                    <p><a href="${ctx}/win88game/indexh5?stype=<%=AESUtil.encrypt("澳门老虎机") %>">澳门老虎机</a></p>
                    <p><a href="${ctx}/win88game/indexh5?stype=<%=AESUtil.encrypt("漫威老虎机") %>">漫威老虎机</a></p>
                    <p><a href="${ctx}/win88game/indexh5?stype=<%=AESUtil.encrypt("累积大奖") %>">累积大奖</a></p>
                    <%-- <p><a href="${ctx}/win88game/indexh5?stype=<%=AESUtil.encrypt("吃角子老虎机") %>">吃角子老虎机</a></p>
                    <p><a href="${ctx}/win88game/indexh5?stype=<%=AESUtil.encrypt("街机游戏") %>">街机游戏</a></p> --%>
