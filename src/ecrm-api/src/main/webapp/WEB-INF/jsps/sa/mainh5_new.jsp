...
<c:set var="statics" value="${ctx}/static/sa2_h5/"></c:set>
...
<html>
	<head>
		...
		<script src="${ctx}/static/sa2/js/jquery-2.4.min.js" type="text/javascript" charset="utf-8"></script>
...
<script type="text/javascript">
	...
	<body>
		...
		<div class="mui-content">
			...
			<div class="search">
	    		<form name="frm1" id="frm1" method="post" action="${ctx}/sagame/mainh5">
		    ...
		    <div class="mui-scroll-wrapper mui-slider-indicator mui-segmented-control mui-segmented-control-inverted scroll_row">	
		        <div class="mui-scroll">
		            ...
		            <c:if test="${stype == '奖金游戏' }"><div class="mui-control-item mui-active" onclick="javascript:location='${ctx}/sagame/mainh5?stype=<%=AESUtil.encrypt("奖金游戏") %>'">奖金游戏</div></c:if>
                	<c:if test="${stype != '奖金游戏' }"><div class="mui-control-item"            onclick="javascript:location='${ctx}/sagame/mainh5?stype=<%=AESUtil.encrypt("奖金游戏") %>'">奖金游戏</div></c:if>
                
                	<c:if test="${stype == '全部游戏' }"><div class="mui-control-item mui-active" onclick="javascript:location='${ctx}/sagame/mainh5?stype=<%=AESUtil.encrypt("全部游戏") %>'">全部游戏</div></c:if>
                	<c:if test="${stype != '全部游戏' }"><div class="mui-control-item"            onclick="javascript:location='${ctx}/sagame/mainh5?stype=<%=AESUtil.encrypt("全部游戏") %>'">全部游戏</div></c:if>
		    	...
		    	<div class="mui-row">
	            	...
	            	<div class="mui-col-sm-4 mui-col-xs-4 lists">
			       		<div>
			            	...
			            	<img src="${ctx }/static/sa2/game/${item.gamecodeh5 }.jpg" alt="" class="gameimg" />
			            	<ul class="try_play">
			            		<!-- <li>免费试玩</li> -->
			            		<li onClick="location='${ctx }/sagame/loginh5?gamecode=${item.gamecodeh5 }'">立即游戏</li>
			            	</ul>	
			            	<h5>${item.cnname}</h5>
			            </div>
			        </div>
	...
	<script type="text/javascript" charset="utf-8">
		$(function() {
			...
			$('.gameimg').error(function(){
		        $(this).attr('src', "${ctx}/static/sa2/game/sa.jpg");
		    });
		});
