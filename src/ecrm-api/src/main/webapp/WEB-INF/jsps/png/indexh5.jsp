...
<html>
	...
	<body>
		<div class="box">
          ...
          <div class="s-logo"><a href="index.html"><img src="${ctx }/static/png/images/logo.png" width="80"></a></div>
			...
			<div id="doc-oc-demo2" class="am-offcanvas">
			  <div class="am-offcanvas-bar">
			    <div class="am-offcanvas-content">
                    <p><a href="${ctx}/pnggame/indexh5?stype=<%=AESUtil.encrypt("最新游戏") %>">最新游戏</a></p>
                    <p><a href="${ctx}/pnggame/indexh5?stype=<%=AESUtil.encrypt("桌面游戏") %>">桌面游戏</a></p>
                    <p><a href="${ctx}/pnggame/indexh5?stype=<%=AESUtil.encrypt("视频扑克") %>">视频扑克</a></p>
                    <p><a href="${ctx}/pnggame/indexh5?stype=<%=AESUtil.encrypt("热门游戏") %>">热门游戏</a></p>
                    <p><a href="${ctx}/pnggame/indexh5?stype=<%=AESUtil.encrypt("多线游戏") %>">多线游戏</a></p>
			    </div>
			  </div>
			</div>
		  </div><!--header结束-->
		  ...
		  <ul class="menu">
		  	<c:forEach var="item" items="${data }" varStatus="i">
			     ...
			     <li> <a href="${ctx }/pnggame/loginh5?gamecode=${item.gamecodeh5}"><img src="${ctx}/static/png/game/${item.gamecodeh5}" width="150" height="150"/> 
