...
@RequestMapping("/DepositBonus")
@Controller
public class ActivityDepositBonusController extends BaseController{
	...
	public String depositBonus(HttpServletRequest request){
		...
		try {
			...
			amount = activityDepositBonusService.tc_depositBonus(String.valueOf(parames.get("employeecode")), 
