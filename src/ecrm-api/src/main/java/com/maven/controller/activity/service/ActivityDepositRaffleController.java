 ...
 *
 */
@RequestMapping("/DepositRaffle")
@Controller
public class ActivityDepositRaffleController extends BaseController{
	...
	public String depositBonus(HttpServletRequest request){
		...
		try {
			...
			Map<String,Object> __result = activityRaffleControlService.cz_raffle(
