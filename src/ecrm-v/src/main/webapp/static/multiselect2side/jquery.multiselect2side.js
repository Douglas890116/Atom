			...
			var htmlToAdd = 
				"<div class='ms2side__div'>" +
					...
					"<div class='ms2side__options'>" +
						...
						?
						("<p class='AddOne' title='Add Selected'>加入选中</p>" +
						"<p class='AddAll' title='Add All'>加入全部</p>" +
						"<p class='RemoveOne' title='Remove Selected'>移除选中</p>" +
						"<p class='RemoveAll' title='Remove All'>移除全部</p>")
						:
