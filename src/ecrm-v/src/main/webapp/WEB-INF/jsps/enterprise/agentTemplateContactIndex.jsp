...
<body style="padding: 10px;">
  <div class="demo-content">
				...
				<div style="position: relative; display: inline-block;">
					<div style="float: left; margin-right: 96px;">
						<div class="control-group span7">
							...
							<input name="sitetype" type="hidden" value="2" />
						</div>
					</div>
					<div style="position: absolute; right: 15px; top: 3px;">
						<button class="button button-primary"><span class="icon-search icon-white"></span>搜索</button>					</div>
					</div>
			</div>
		</form>
	...
	<div id="grid"></div>
		...
		var template_editor = ${sessionScope.ERCM_USER_PSERSSION['MN00A4'].menustatus ==1 };
		...
		(function() {
				...
				var Grid = BUI.Grid, 
					...
					columns = [
						...
						{title : '已有代理模板',width : '80%',sortable : true,dataIndex : 'webviews',selectable : true},
			...
			function templateContactAdd(enterprisecode,sign){
				top.topManager.openPage({
					...
					href : '${ctx}/brandTemplate/agentTemplateContactAdd?enterprisecode='+enterprisecode+'&sign='+sign,
					title : '分配代理模板'
				});
			}
		</script>
