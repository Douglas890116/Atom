...
<div class="demo-content" style="margin: 27px;">
        ...
        <form aria-pressed="false" aria-disabled="false" id="objForm" class="form-horizontal bui-form bui-form-field-container" method="post" >
            ...
            <div class="control-group">
              <label class="control-label">品牌名称：</label>
                <div class="controls">
                  <input name="brandcode" type="hidden" value="${brand.brandcode }">
                  <input name="brandname" value="${brand.brandname}" class="input-small control-text" style="width:167px;height:18px;" type="text" data-rules="{required:true,maxlength:8}" data-tip="{text:'长度不超过8个字符'}"/>
                </div>
            </div>
            <div class="control-group">
              <label class="control-label">前台模板：</label>
              <div class="controls">
                <select name="webtemplatecode" data-defualt="${brand.webtemplatecode}" aria-disabled="false" style="width:192px;height:30px;" class="bui-form-field-select bui-form-field" data-rules="{required:true}">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <input type="hidden"  name="logopath" value="${brand.logopath}" data-rules="{required:true}"/>
                    <span><img id="imgId" src="${brand.logopath}" style="width: 80px;height: 25px;border: 1px solid #F6F6F6"></span>
    ...
    $(function () {
    	...
    	var form = new BUI.Form.HForm({
   		...
   		bindClick("J_Form_Submit","${ctx}/EOBrand/Update",form);
    }); 
    </script>
<!-- script end -->
  </div>
