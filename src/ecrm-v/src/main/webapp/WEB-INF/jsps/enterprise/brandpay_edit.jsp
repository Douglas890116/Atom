    ...
    <div class="row">
      <div>
        ...
        <form aria-pressed="false" aria-disabled="false" id="objForm" class="form-horizontal bui-form bui-form-field-container" method="post" >
            ...
            <input name="lsh"  type="hidden" value="${enterpriseOperatingBrandPay.lsh }"/>
            <input name="sign"  type="hidden" value="${sign }"/>
            
            <div class="control-group">
              <label class="control-label"><font color="red">*</font>品牌名称：</label>
              <div class="controls">
                <select name="brandcode" aria-disabled="false" style="width:192px;height:30px;" class="bui-form-field-select bui-form-field" value="${enterpriseOperatingBrandPay.brandcode }">
            ...
            <div class="control-group">
              <label class="control-label"><font color="red">*</font>支付回调域名：</label>
                <div class="controls">
                  <input name="paycallbackurl" class="input-small control-text" style="width:167px;height:20px;" type="text" data-rules="{required:true,maxlength:255}" value="${enterpriseOperatingBrandPay.paycallbackurl }" data-tip="{text:'长度不超过255个字符'}"/>
            ...
            <div class="control-group">
              <label class="control-label"><font color="red">*</font>后台管理域名：</label>
                <div class="controls">
                  <input name="adminurl" class="input-small control-text" style="width:167px;height:20px;" type="text" data-rules="{required:true,maxlength:255}" value="${enterpriseOperatingBrandPay.adminurl }" data-tip="{text:'长度不超过255个字符'}"/>
                  http或hppts开头的顶级、二级、三级等域名
                </div>
            </div>
