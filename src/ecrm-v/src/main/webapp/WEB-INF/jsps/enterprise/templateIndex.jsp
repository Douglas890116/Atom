				...
				<div style="position: relative; display: inline-block;">
					<div style="float: left; margin-right: 96px;">
						<div class="control-group span7">
							...
							<input name="sitetype" type="hidden" class="control-text" value="1"/>
						</div>
					</div>
	...
	<div id="grid"></div>
			...
			(function() {
    					...
    					botton_arry.push({
    						...
    						handler : function() {
    							top.topManager.openPage({
    								id : 'create_template',
    								href : '${ctx}/brandTemplate/addTemplate',
    								title : '创建模板'
    							});
    						}
    					});
				...
				function editorTemplate(webtemplatecode,sign){
					top.topManager.openPage({
						id : 'update_template',
						href : '${ctx}/brandTemplate/updTemplate?webtemplatecode='+webtemplatecode+'&sign='+sign,
						title : '修改模板'
					});
				}
			</script>
