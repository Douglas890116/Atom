...
<div class="demo-content" >
      ...
      <div>
        ...
        <form aria-pressed="false" aria-disabled="false" id="objForm" class="form-horizontal bui-form bui-form-field-container" method="post" >
            ...
            <div class="control-group">
				...
				<div class="controls">
					<select style="width: 248px;" name="brandcode" value="${banner.brandcode }">
            ...
            <div class="control-group">
              <label class="control-label"><font color="red">*</font>图片名称：</label>
                <div class="controls">
                  <input name="bannername" class="input-small control-text" style="width:167px;height:20px;" value="${banner.bannername }" type="text" data-rules="{required:true,maxlength:50}" data-tip="{text:'长度不超过50个字符'}"/>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label">图片类型：</label>
                <div class="controls">
                    <select style="width: 248px;" name="bannertype" value="${banner.bannertype}">
            ...
            <div class="control-group">
              <label class="control-label"><font color="red">*</font>图片路径：</label>
                <div class="controls">
                  <input name="linkpath" class="input-small control-text" style="width:167px;height:20px;" value="${banner.linkpath }" type="text" data-rules="{required:true,maxlength:500}" data-tip="{text:'长度不超过500个字符'}"/>
                </div>
            </div>
            <div class="control-group">
              <label class="control-label"><font color="red">*</font>显示排序：</label>
                <div class="controls">
                  <input name="ord" class="input-small control-text" style="width:167px;height:20px;" value="${banner.ord }" type="text" data-rules="{required:true,maxlength:2}" data-tip="{text:'长度不超过2个字符'}"/>
                </div>
            </div>
            <input type="hidden"  name="lsh" value="${banner.lsh }"/>
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <input type="hidden"  name="logopath" data-rules="{required:true}" value="${banner.imgpath }"/>
                    <span><img id="imgId" src="${banner.imgpath }" style="width: 80px;height: 25px;border: 1px solid #F6F6F6;display: bloack;"></span>
    ...
    $(function () {
    	...
    	var form = new BUI.Form.HForm({
   		...
   		bindClick("J_Form_Submit","${ctx}/banner/update",form);
    }); 
    </script>
<!-- script end -->
  </div>
