...
<!-- 用户新增按钮是否有操作权限 -->
    ...
    (function(){
        ...
        function permissionValidate(){
        	...
        	if(add_brand){
        		array.push({
                  ...
                  handler : function(){
                	 openNewWindow('create_brand','${ctx}/banner/add','新增图片');
                  }
              });
        	}
        	if(delete_brand){
		...
		{ title: '编号',width:'10%', dataIndex: 'lsh'},
            ...
            { title: '图片名称',width:'15%', dataIndex: 'bannername'},
            ...
            { title: '操作',width:360,sortable: false,renderer:function(value,obj){
            	var  html = "";
            	html += '<button type="button" onclick="openNewWindow(\'edit_banner\',\'${ctx}/banner/edit?lsh='
						+ obj.lsh
