...
<div class="demo-content" style="margin: 27px;">
        ...
        <form aria-pressed="false" aria-disabled="false" id="objForm" class="form-horizontal bui-form bui-form-field-container" method="post" >
            <div class="control-group">
              <label class="control-label">进&nbsp;出&nbsp;帐&nbsp;类&nbsp;型：</label>
           		<div class="controls">
           			<select name="moneyinouttype" aria-pressed="false" aria-disabled="false"   class="bui-form-field-select bui-form-field span5">
            ...
            <div class="control-group">
              <label class="control-label">帐变类型类别：</label>
           		<div class="controls">
           			<select name="moneychangetypeclassify" aria-pressed="false" aria-disabled="false" data-rules="{required:true}" class="bui-form-field-select bui-form-field span5">
						<option value="">请选择</option>
            ...
            <div class="control-group">
              ...
              <div class="controls">
              	<input type="text" name="moneychangetype" data-rules="{required:true}" class="input-small control-text" style="width:167px;height:18px;">
              </div>
            </div>
            <br>
            <hr/>
    ...
    $(function () {
    	...
    	bindAddClick("J_Form_Submit","${ctx}/moneyChangeType/save",form);
    }); 
    </script>
<!-- script end -->
  </div>
