  ...
  <div class="admin-content-body">
    ...
    <input type="hidden" id="employeecode" value="${employeecode}"/>
      <ul class="am-tabs-nav am-nav am-nav-tabs">
        <li class="am-active"><a href="#tab1">游戏信息</a></li>
        <li class=""><a href="#tab2">余额转换</a></li>
      ...
      <div class="am-tabs-bd">
        ...
        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
          ...
          <tbody>
          <c:if test="${gameAccounts != null && fn:length(gameAccounts) > 0}">
            <c:forEach items="${gameAccounts}" var="data" varStatus="i">
              <tr>
                <td>${data.gamename}</td>
                <td>${data.gameaccount}</td>
                <td><fmt:formatNumber value="${data.balance}" pattern="##.##" minFractionDigits="2"/></td>
                <td>${data.gamepassword}</td>
              </tr>
            </c:forEach>
          </c:if>
          </tbody>
        ...
        <center>
          <table border="1" style="width: 360px; border: 1px solid grey; font-size: 13px; text-align: center; vertical-align: middle;">
          <tbody id="userBanlance">
