  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">打码结算</strong> / <small>代理打码周结算</small></div>
      </div>

      <hr>

    <form class="am-form" action="${ctx}/h5/agentWeeklyReport" method="post">
      <div class="am-g">
        ...
        <div class="am-u-sm-12">
            ...
            <table class="am-table am-table-striped am-table-hover table-main am-table-centered">
              ...
              <tr>
                ...
                <th class="starttime-endtime">报表时间段</th>
              ...
              <c:forEach items="${list}" var="data" varStatus="i">
	              <tr>
	                ...
	                <td class="am-text-middle "><fmt:formatDate value="${data.starttime}" pattern="yyyy-MM-dd"/>-<fmt:formatDate value="${data.endtime}" pattern="yyyy-MM-dd"/></td>
