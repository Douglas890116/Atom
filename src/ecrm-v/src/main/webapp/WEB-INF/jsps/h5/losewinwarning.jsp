  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">风险管理</strong> / <small>会员输赢预警</small></div>
      </div>
        ...
        <div class="am-u-sm-12">
            ...
            <table class="am-table am-table-striped am-table-hover table-main am-table-centered">
              ...
              <tr>
                ...
                <th class="table-platformtype">游戏平台</th>
                <th class="table-betmoney">投注总额</th>
                <th class="table-netmoney">输赢总额</th>
                <th class="table-">输赢比</th>
              </tr>
              </thead>
              <tbody>
              ...
              <c:forEach items="${list}" var="data" varStatus="i">
                  <tr>
                    ...
                    <td class="">${data.platformtype}</td>
                    <td class=""><fmt:formatNumber value="${data.betmoney}" pattern="##.##" minFractionDigits="2"/></td>
                    <td class=""><fmt:formatNumber value="${data.netmoney}" pattern="##.##" minFractionDigits="2"/></td>
                    <td class="">
                    <c:set var="rate" value="${(data.netmoney / (data.betmoney+1)) * 100}"/>
                    <c:if test="${rate < 1}">
