  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">占成待结算</strong> / <small>占成待结算Ｂ</small></div>
      </div>

      <hr>

    <form class="am-form" action="${ctx}/h5/nbReportB" method="post">
      <div class="am-g">
            ...
            <table class="am-table am-table-striped am-table-hover table-main am-table-centered">
              ...
              <c:forEach items="${list}" var="data" varStatus="i">
                  <tr class="${i.count == 1 ? 'am-active' : ''}">
                    ...
                    <td class="am-text-middle am-hide-sm-only">会员：${data.countMember} | 代理：${data.countAgent}</td>
