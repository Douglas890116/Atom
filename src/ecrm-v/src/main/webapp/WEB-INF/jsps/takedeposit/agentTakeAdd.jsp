        ...
        <hr>
            <form  id="objForm" method="post" class="form-horizontal">
               <div class="control-group">
                  <label class="control-label">取&nbsp;&nbsp;款&nbsp;&nbsp;&nbsp;账&nbsp;&nbsp;&nbsp;号：</label>
                  <div class="controls">
                      <input class="input-normal control-text" name="loginaccount" type="text" style="width:167px;height:18px;" value="${employeeAgent.loginaccount }" readonly="readonly" data-tip="{text:'请输入用户账号'}"  data-rules="{required:true}" />
                      <input type="hidden" name="employeecode" value="${employeeAgent.employeecode }" data-rules="{required:true}"/>
                  </div>
              </div>
              <div class="control-group">
              ...
              <div class="control-group">
                <label class="control-label">取&nbsp;&nbsp;&nbsp;款&nbsp;&nbsp;&nbsp;备&nbsp;&nbsp;注：</label>
                <div class="controls">
...
<script type="text/javascript">
	$(function(){
		...
		$.ajax({
			...
			data:{'employeecode':'${employeeAgent.employeecode}'},
			dataType: "json",
		...
		$("#J_Form_Submit").click(function() {
			if(form.isValid()){
				...
				$.ajax({
					type: "POST",
					url: "${ctx}/takeDepositRecord/agentWithdrawOrders",
					//url: "${ctx}/takeDepositRecord/testActivity",
