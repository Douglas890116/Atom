      	...
      	<div style="float: left;margin-right: 96px;">
            ...
            <div class="control-group span7">
              <label class="control-label">管理账号：</label>
                <input name="operaer" class="input-small control-text"  type="text" />
            </div>
    ...
    (function(){
        ...
        var Grid = BUI.Grid,
          ...
          columns = [
            ...
            { title: '业务类别',width:'6%', dataIndex: 'operatype'},
            { title: '内容描述',width:'50%', dataIndex: 'content'},
            { title: '操作人',width:'16%', dataIndex: 'operaer'},
            { title: '操作时间',width:'10%', dataIndex: 'createtime',renderer:BUI.Grid.Format.datetimeRenderer},
            { title: '备注',width:'12%', dataIndex: 'remark'}
          ];
      
        store = new Store({
            url : '${ctx}/userlog/adminlogdata',
            autoLoad : false,
            pageSize: 15,
            sortInfo : {
                field : 'createtime',
