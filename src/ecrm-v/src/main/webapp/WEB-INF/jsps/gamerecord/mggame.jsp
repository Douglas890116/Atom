    ...
    <div style="position: relative;display: inline-block;">
      <div style="float: left;margin-right: 96px;">
           ...
           <div class="control-group span7">
            ...
            <div class="control-group span7">
              <label class="control-label">游戏代码：</label>
                <input name="mgGameId"  type="text" data-tip='{"text":"游戏代码"}' class="control-text" placeholder="游戏代码"/>
            </div>
            <%-- <div class="control-group span7">
           ...
           <div class="control-group span7">
              <label class="control-label">投注单号：</label>
                <input name="mgColId"  type="text" data-tip='{"text":"投注单号"}' value="${param.mgColId }" class="control-text" placeholder="投注单号"/>
            </div>
  ...
  <div id="grid"></div>
   ...
   if(export_excel){
    botton_arry.push({
              ...
              handler:function(){
                searchForm.action = "${ctx}/MgGame/exportExcel";
                searchForm.submit();
                searchForm.action = "${ctx}/MgGame/data";
              }
    });
   }
   ...
   $(function(){
	   ...
	   if(!begintime.val()&&!endtime.val()){
        ...
        var Grid = BUI.Grid,
          ...
          columns = [
			{ title: '投注单号',   width: '11%',  sortable: true,dataIndex:'mgColId'},
			{ title: '游戏代号',   width: '12%',  sortable: false,dataIndex:'mgGameId'},
			{ title: '游戏名称',   width: '12%',  sortable: false,dataIndex:'mgMgsGameId'},
			{ title: '用户账号',width: '12%',  sortable: false,dataIndex:'loginaccount'},
			{ title: '记录类型',   width: '8%',  sortable: false, dataIndex:'mgTransType', renderer:function(value){
				if(value == "bet") return "投注";
				else return "派彩";
			}},
			{ title: '投注金额',   width: '10%',  sortable: false,summary : true, dataIndex:'mgAmount', renderer:function(value){
				return parseFloat(value).toFixed(2);
			}},
			{ title: '输赢金额',   width: '10%',  sortable: false,summary : true, dataIndex:'netMoney', renderer:function(value){
				return parseFloat(value).toFixed(2);
			}},
			/* { title: '下注后余额',   width: '10%',  sortable: false,summary : true, dataIndex:'mgBalance', renderer:function(value){
				return parseFloat(value).toFixed(2);
			}}, */
