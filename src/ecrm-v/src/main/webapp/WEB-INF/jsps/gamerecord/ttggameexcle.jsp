...
<body>
    ...
    <table width="100%" cellpadding="4" cellspacing="0" class="toTab" border="0">
        <thead>
            ...
            <th class="toLabelTd">游戏</th>
            
            <th class="toLabelTd">交易类型</th>
        ...
        <tbody>
            <c:forEach var="item" items="${listData}" varStatus="i">
                <tr>
                    ...
                    <td class="toDataTd">${item.handid}</td>
                    <td class="toDataTd">${item.loginaccount}</td>
                    <td class="toDataTd">${item.game}</td>
                    
                    <td class="toDataTd">${item.transactiontype}</td>
                    ...
                    <td class="toDataTd"><fmt:formatDate value="${item.resolvetime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
