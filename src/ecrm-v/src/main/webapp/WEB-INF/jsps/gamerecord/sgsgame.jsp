  ...
  <div id="grid"></div>
   ...
   if(export_excel){
    botton_arry.push({
              ...
              handler:function(){
                searchForm.action = "${ctx}/sgsgame/exportExcel";
                searchForm.submit();
                searchForm.action = "${ctx}/sgsgame/data";
              }
    });
   }
   $(function(){
	   ...
	   if(!begintime.val()&&!endtime.val()){
        ...
        var Grid = BUI.Grid,
          ...
          columns = [
			...
			{ title: '有效投注额',   width: '6%',  sortable: false,summary : false, dataIndex:'validmoney', renderer:function(value){
				return parseFloat(value).toFixed(2);
			}},
