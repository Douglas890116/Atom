    ...
    <div style="position: relative;display: inline-block;">
      <div style="float: left;margin-right: 96px;">
           ...
           <div class="control-group span7">
              ...
              <select name="gameid">
                  <option value="">--请选择--</option>
                  <option value="101">捕鱼天下	</option>
                  <option value="103">单挑王</option>
                  <option value="104">金鲨银鲨</option>
              </select>
            </div>
            <div class="control-group span7">
  ...
  <div id="grid"></div>
   ...
   if(export_excel){
   	botton_arry.push({
   	          ...
   	          handler:function(){
   	          	searchForm.action = "${ctx}/gggame/exportExcel";
   	          	searchForm.submit();
   	          	searchForm.action = "${ctx}/gggame/data";
   	          }
   	});
   }
   ...
   $(function(){
	   ...
	   if(!begintime.val()&&!endtime.val()){
        ...
        var Grid = BUI.Grid,
          ...
          columns = [
			{ title: '投注单号',   width: '11%',  sortable: true,dataIndex:'autoid'},
			{ title: '游戏代号',   width: '12%',  sortable: false,dataIndex:'gameid'},
			{ title: '游戏账号',   width: '15%',  sortable: false,dataIndex:'accountno'},
