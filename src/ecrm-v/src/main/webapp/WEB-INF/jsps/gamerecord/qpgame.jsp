  ...
  <div id="grid"></div>
   ...
   if(export_excel){
    botton_arry.push({
              ...
              handler:function(){
                searchForm.action = "${ctx}/QpGame/exportExcel";
                searchForm.submit();
                searchForm.action = "${ctx}/QpGame/data";
              }
    });
   }
	   ...
	   if(!begintime.val()&&!endtime.val()){
        ...
        var Grid = BUI.Grid,
          ...
          columns = [
			...
			/* { title: '游戏类型',width: '12%',  sortable: false,dataIndex:'serverId'},
			{ title: '房间类型',width: '12%',  sortable: false,dataIndex:'kindId'}, */
			{ title: '房间名称',   width: '12%',  sortable: false,dataIndex:'roomName'},
			{ title: '底注',   width: '10%',  sortable: false,summary : true, dataIndex:'betmoney', renderer:function(value){
			...
			{ title: '结算时间',   width: '20%',  sortable: false,dataIndex:'endTime',renderer:BUI.Grid.Format.datetimeRenderer}
          ];
