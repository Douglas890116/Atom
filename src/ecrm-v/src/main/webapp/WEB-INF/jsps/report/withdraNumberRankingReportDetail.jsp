...
<!-- 搜索页 ================================================== -->
  <form id="searchForm" class="form-horizontal" style="outline: none;" method="post">
	...
	<input type="text" value="${employeecode}" name="employeecode"/>
	<input type="text" value="${orderStartDate}" name="orderStartDate"/>
	<input type="text" value="${orderEndDate}" name="orderEndDate"/>
   	...
   	var select_audit = ${sessionScope.ERCM_USER_PSERSSION['MN003P'].menustatus == 1 || sessionScope.ERCM_USER_PSERSSION['MN003R'].menustatus == 1 };
        ...
        var Grid = BUI.Grid,
          ...
          columns = [
            ...
            { title: '处理时长',width: '5%',  sortable: false,renderer:function(value,obj){
        ...
        var store = new Store({
            url : '${ctx}/report/queryWithdraNumberRankingReportDetail',
