...
var Grid = BUI.Grid,
  ...
  columns = [
	...
	{ title: '投注总额',width: '10%',elCls:'center',  sortable: false,  dataIndex: 'game_betting_amount'},
	{ title: '输赢金额',width: '10%',elCls:'center',  sortable: false,  dataIndex: 'lose_win_amount',renderer:function(value){
		if((value+"").indexOf("-")<0){
			return "<span style='color:#29B529;font-size:medium;'>"+value+"</span>";
		}else{
			return "<span style='color:red;font-size:medium;'>"+value+"</span>";			
		}
	}},
	{ title: '洗码金额',width: '10%',elCls:'center',  sortable: false,  dataIndex: 'bonus'},
	{ title: '分红金额',   width: '10%', elCls:'center', sortable: false, dataIndex: 'dividend'},
    { title: '占成金额',   width: '10%', elCls:'center', sortable: false, dataIndex: 'share'},
...
var store = new Store({
    url : '${ctx}/report/queryUserLoseWinCount',
    autoLoad:false, 
    pageSize:15
  }),
  grid = new Grid.Grid({
