  ...
  <div class="demo-content">
    <div class="row">
      ...
      <div class="span16" style="width:1510px;">
        <div class="panel panel-head-borded panel-small">
          <div class="panel-header">拥有该权限组的所有用户</div>
          <div id="grid">
...
<script type="text/javascript">
     ...
     var store = new Data.Store({
          url : '${ctx}/EmployeeMPG/queryHavePermissiongroupEmployee',
    	        ...
    	        handler : function(){
    		      ...
    		      //获取权限组编码
    		        ...
    		        if(isEmpty(buffvalue.join(""))){
    		        	BUI.Message.Alert("请先选择需要删除授权的用户！！！","warning");
    		        	return false;
    		        }
    		        BUI.Message.Confirm('确认删除所选用户的权限吗？',function(){
 	        		   var buffvalue=[];
 	    		        $("input[name='selectName']:checked").each(function(index){
 	    		        	index++;
 	    		        	buffvalue.push($(this).val());
 	    		        ...
 	    		        //批量删除用户的权限编码
 	    		        $.ajax({
 	                		url:'${ctx}/EmployeeMPG/batchDeleteEmployeePerssionGroup',
 	                		type:"post",
 	                		dataType:"json",
 	                		data:{employeecode:buffvalue.join(""),permissiongroupcode:permissiongroupcode},
 	                		success:function(data){
 	                			if(data.status > 0){
                    				BUI.Message.Alert('权限删除成功','success');
