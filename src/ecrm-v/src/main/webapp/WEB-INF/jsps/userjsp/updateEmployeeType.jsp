...
<div class="demo-content" style="margin: 27px;">
    ...
    <div class="row">
      <div>
        <h2><a href="${ctx}/EInformation/list">用户类型管理</a><span class="divider"> / </span>修改用户类型</h2>
        <hr/>
        <form aria-pressed="false" aria-disabled="false" id="objForm" class="form-horizontal bui-form bui-form-field-container" method="post" >
            <div class="control-group">
              ...
              <div class="controls">
                <input type="hidden" value="${obj.employeetypecode}" name="employeetypecode">
              	<input name="employeetype" class="input-small control-text" style="width:167px;height:18px;" value="${obj.employeetype}" type="text" data-rules="{required:true,maxlength:16}"/>
              </div>
            </div>
            <hr/>
            <div class="row actions-bar">       
	          <div class="form-actions span13 offset3">
            <c:if test="${sessionScope.ERCM_USER_PSERSSION['MN0066'].menustatus==1}">
    ...
    $(function () {
    	...
    	bindClick("J_Form_Submit","${ctx}/employeeType/saveUpdate",form);
    });
    </script>
<!-- script end -->
  </div>
