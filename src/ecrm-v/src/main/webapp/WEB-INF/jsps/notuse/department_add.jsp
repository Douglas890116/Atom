...
<div class="demo-content" style="margin: 27px;">
      ...
      <div>
        ...
        <form aria-pressed="false" aria-disabled="false" id="objForm" class="form-horizontal bui-form bui-form-field-container" method="post" >
            <div class="control-group">
              ...
              <div class="controls">
                <input aria-pressed="false" aria-disabled="false" disabled="disabled" style="width:167px;height:18px;"  class="control-text bui-form-field" type="text" value="${sessionScope.ERCM_USER_SESSION.enterprise.enterprisename}" />
                <input name="enterprisecode" class="input-normal control-text"  type="hidden"  value="${sessionScope.ERCM_USER_SESSION.enterprise.enterprisecode}"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">部门名称：</label>
              <div class="controls">
              	<input name="department" class="input-small control-text" style="width:167px;height:18px;" type="text" data-rules="{required:true,maxlength:8}"/>
              </div>
            </div>
            <hr/>
    ...
    $(function () {
    	...
    	var form = new BUI.Form.HForm({
     	...
     	bindClick("J_Form_Submit","${ctx}/Department/save",form);
    });
    </script>
<!-- script end -->
  </div>
