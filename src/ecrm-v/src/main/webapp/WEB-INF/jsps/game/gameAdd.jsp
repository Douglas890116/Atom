...
<div class="demo-content" style="margin: 27px;">
      ...
      <div>
        ...
        <form aria-pressed="false" aria-disabled="false" id="objForm" class="form-horizontal bui-form bui-form-field-container" method="post" >
            <div class="control-group">
              ...
              <div class="controls">
              	<input type="text" name="gametype" data-rules="{required:true}" class="input-small control-text" style="width:167px;height:18px;">
              </div>
            </div>
            <br>
            <div class="control-group">
              <label class="control-label">游戏名称：</label>
                <div class="controls">
                  <input name="gamename" class="input-small control-text" style="width:167px;height:18px;" type="text" data-rules="{required:true}"/>
                </div>
            </div>
            <br> 
             <div class="control-group">
              <label class="control-label">排列顺序：</label>
                <div class="controls">
                  <input name="sort" class="input-small control-text" style="width:167px;height:18px;" type="text" data-rules="{required:true}"/>
                </div>
            </div>
            <hr/>
    ...
    $(function () {
    	...
    	bindAddClick("J_Form_Submit","${ctx}/gametype/save",form);
    }); 
    </script>
<!-- script end -->
  </div>
