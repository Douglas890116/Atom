...
<div class="demo-content" style="margin: 27px;">
    ...
    <div class="row">
      <div>
        ...
        <form aria-pressed="false" aria-disabled="false" id="objForm" class="form-horizontal bui-form bui-form-field-container" method="post" >
            <input type="hidden" name="paymenttypecode" value="${paymentType.paymenttypecode}" />
            <div class="control-group">
              <label class="control-label">游戏类型：</label>
              <div class="controls">
              	<input type="text" name="paymenttype" data-rules="{required:true}"  value="${paymentType.paymenttype}" class="input-small control-text" style="width:167px;height:18px;" />
              </div>
            </div>
            <hr/>
    ...
    $(function () {
    	...
    	var form = new BUI.Form.HForm({
   		...
   		bindClick("J_Form_Submit","${ctx}/paymenttype/updateSave",form);
    }); 
    </script>
<!-- script end -->
  </div>
