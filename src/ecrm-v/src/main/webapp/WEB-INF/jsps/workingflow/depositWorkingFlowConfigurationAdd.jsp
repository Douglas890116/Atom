  ...
  <div class="demo-content" style="margin: 27px;">
    <div class="row">
      <div>
        ...
        <hr>
            <form:form method="post" class="form-horizontal" id="objForm">
              <div class="control-group">
                <label class="control-label">工作流创建企业:</label>
                <div class="controls">
                     <input type="text" value="${sessionScope.ERCM_USER_SESSION.enterprisename}" disabled="disabled" class="input-normal control-text" style="width:167px;height:20px;"/>
...
$(function(){
	...
	bindAddClick("J_Form_Submit","${ctx}/workingFlow/saveDepositWorkingFlowConfiguration",form);
});
</script>
