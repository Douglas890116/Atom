  ...
  <div class="demo-content" style="margin: 27px;">
    <div class="row">
      <div>
        ...
        <hr>
            <form:form method="post" id="objForm" action="${ctx}/workingFlow/updateDepositWorkingFlowConfiguration" class="form-horizontal">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <div class="common_mark">(存款金额大于或者等于该条件则启动流程)</div>
                </div>
              </div>
              <div class="control-group">
               ...
               <div class="control-group">
                ...
                <div class="controls">
                      <label class="radio" for="enable1"><input type="radio" id="enable1" name="enable" value="1" style="width:16px;"  ${WorkingFlowConfiguration.enable==1?"checked='checked'":""} />启用</label>&nbsp;&nbsp;&nbsp;
                      <label class="radio" for="enable2"><input type="radio" id="enable2" name="enable" value="0" style="width:16px;"  ${WorkingFlowConfiguration.enable==0?"checked='checked'":""} />禁用</label>
                      <div class="common_mark"></div>
                </div>
              </div>
              <hr>
...
$(function(){
	...
	bindClick("J_Form_Submit","${ctx}/workingFlow/updateDepositWorkingFlowConfiguration",form);
});
</script>
