...
<div class="demo-content" style="margin: 27px;">
        ...
        <form aria-pressed="false" aria-disabled="false" id="objForm" class="form-horizontal bui-form bui-form-field-container" method="post" >
            ...
            <div class="control-group">
              <label class="control-label" style="margin-right: 12px;">参数字段：</label>
                <div class="controls">
                  <input name="agementname" class="input-small control-text" style="width:167px;height:18px;" type="text" data-rules="{required:true}" data-tip="{text:'请输入参数字段'}"/>
                </div>
            </div>
            ...
            <div class="control-group">
              <label class="control-label" style="margin-right: 12px;">参数描述：</label>
                <div class="controls">
                  <input name="agementdesc" class="input-small control-text" style="width:167px;height:18px;" type="text" data-rules="{required:true}" data-tip="{text:'请输入参数描述'}"/>
                </div>
            </div>
    ...
    $(function () {
    	...
    	var form = new BUI.Form.HForm({
   		...
   		bindClick("J_Form_Submit","${ctx}/ATemplateSetting/Save",form);
    }); 
    </script>
<!-- script end -->
  </div>
