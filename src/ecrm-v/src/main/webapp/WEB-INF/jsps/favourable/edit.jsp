...
<div class="demo-content" style="margin: 27px;">
    ...
    <div class="row">
      <div>
        ...
        <form aria-pressed="false" aria-disabled="false" id="objForm" class="form-horizontal bui-form bui-form-field-container" method="post" >
            ...
            <input name="lsh" value="${favourable.lsh }" type="hidden"  />
            
            <div class="control-group">
              <label class="control-label" >优惠名称：</label>
                <div class="controls">
                  <input name="favourablename" value="${favourable.favourablename }" class="input-small control-text" style="width:167px;height:18px;" type="text" data-rules="{required:true}" />
                </div>
            </div>
            ...
            <div class="control-group">
              <label class="control-label" >流水倍数：</label>
                <div class="controls">
                  <input name="lsbs" value="${favourable.lsbs }" class="input-small control-text" style="width:167px;height:18px;" type="text" data-rules="{required:true,number:true}" />
                </div>
            </div>
            
            <fmt:formatDate type="both" value="${favourable.starttime }" var="starttime"></fmt:formatDate>
            <fmt:formatDate type="both" value="${favourable.endtime }" var="endtime"></fmt:formatDate>
            
            <div class="control-group">
              <label class="control-label" >开始时间：</label>
              <div class="controls">
                  <input name="starttime" value="${starttime }" class="calendar calendar-time" style="width:167px;height:18px;" type="text" data-rules="{required:true}" data-tip="{text:'请输入活动开始时间'}"/>
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
              	<select name="isonce" aria-disabled="false" class="bui-form-field-select bui-form-field" style="width: 193px;" value="${favourable.isonce }">
            ...
            <div class="control-group">
              ...
              <div class="controls">
              	<select name="isdeault" aria-disabled="false"  class="bui-form-field-select bui-form-field" style="width: 193px;" value="${favourable.isdeault }">
                  <option value="">--请选择--</option>
            ...
            <div class="control-group">
              ...
              <div class="controls">
              	<select name="status" aria-disabled="false"  class="bui-form-field-select bui-form-field" style="width: 193px;" value="${favourable.status }">
                  <option value="">--请选择--</option>
    ...
    $(function () {
    	...
    	var form = new BUI.Form.HForm({
   		...
   		bindClick("J_Form_Submit","${ctx}/favourable/Update",form);
    }); 
    </script>
<!-- script end -->
  </div>
