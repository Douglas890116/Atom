...
public class WithdrawPlayerMoneyResponse  implements java.io.Serializable {
    private com.hy.pull.common.util.game.hb.MoneyResponse withdrawPlayerMoneyResult;

    public WithdrawPlayerMoneyResponse() {
    }

    public WithdrawPlayerMoneyResponse(
           com.hy.pull.common.util.game.hb.MoneyResponse withdrawPlayerMoneyResult) {
     ...
     */
    public com.hy.pull.common.util.game.hb.MoneyResponse getWithdrawPlayerMoneyResult() {
        return withdrawPlayerMoneyResult;
    }
     ...
     */
    public void setWithdrawPlayerMoneyResult(com.hy.pull.common.util.game.hb.MoneyResponse withdrawPlayerMoneyResult) {
        this.withdrawPlayerMoneyResult = withdrawPlayerMoneyResult;
    }
