...
public class LoginOrCreatePlayer  implements java.io.Serializable {
    private com.hy.pull.common.util.game.hb.LoginOrCreatePlayerRequest req;

    public LoginOrCreatePlayer() {
    }

    public LoginOrCreatePlayer(
           com.hy.pull.common.util.game.hb.LoginOrCreatePlayerRequest req) {
           this.req = req;
    }
     ...
     * @return req
     */
    public com.hy.pull.common.util.game.hb.LoginOrCreatePlayerRequest getReq() {
        return req;
    }
     ...
     * @param req
     */
    public void setReq(com.hy.pull.common.util.game.hb.LoginOrCreatePlayerRequest req) {
        this.req = req;
    }
