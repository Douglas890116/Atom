...
public class WithdrawPlayerMoney  implements java.io.Serializable {
    private com.hy.pull.common.util.game.hb.WithdrawPlayerMoneyRequest req;

    public WithdrawPlayerMoney() {
    }

    public WithdrawPlayerMoney(
           com.hy.pull.common.util.game.hb.WithdrawPlayerMoneyRequest req) {
           this.req = req;
    }
     ...
     * @return req
     */
    public com.hy.pull.common.util.game.hb.WithdrawPlayerMoneyRequest getReq() {
        return req;
    }
     ...
     * @param req
     */
    public void setReq(com.hy.pull.common.util.game.hb.WithdrawPlayerMoneyRequest req) {
        this.req = req;
    }
