 ...
 * @author temdy
 */
public class AGGameAPI implements BaseInterface {
	
	private String API_URL = "http://cashapi.dg20mu.com/cashapi/getdata.aspx";
...
//	http://cashapi.dg20mu.com/cashapi/getdata.aspx?params=
	 ...
	 * @param KEY 密钥
	 */
	public AGGameAPI(String API_URL,String KEY,String AGENT,String GAME_API_URL){
...
//			param.append(entity.get("platformname"));
	...
	public static void main(String[] arg){
		AGGameAPI og = new AGGameAPI();
		Map<String, Object> entity = new HashMap<String, Object>();
		entity.put("username", "hylgfsd90@#_&*8dx2xx");
		entity.put("password", "dsadasds");
...
//		entity.put("billno", StringUtils.getCurrenDate()+"12");
		entity.put("credit", "0.1");
		
		entity.put("billno", "2016112413431312");
		entity.put("type", "IN");
...
//		System.out.println(og.getClass().getSimpleName());
