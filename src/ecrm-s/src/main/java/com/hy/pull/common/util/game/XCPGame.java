...
public class XCPGame {
	...
	public static List<Map<String, Object>> getXCPGame(String apiUrl, String agent, String btime, String etime, String deskey,
			String firstkey, String lastkey) throws Exception {
		if(apiUrl == null){
			apiUrl = "http://dev.huoxing777.com/_api/webApis2.php?RetailParams=";
		}
		...
		if ("1".equals(code)) {
			...
			if (affects > ipagerecords) {
				...
				for (int i = 1; i <= pagesum; i++) {
					...
					list.addAll(getXCPGame(agent, data));
				}
			} else {
				list.addAll(getXCPGame(agent, data));
			}
	...
	public static void main(String[] agrs){
		try {
			System.out.println(getXCPGame(null,"xrzd66","2016-11-04 00:00:00","2016-11-04 23:59:59","abcd1234","123456","98766"));
		} catch (Exception e) {
