...
public class DeEnCode {
	...
	public static void main(String[] args) {
		String md5 = DeEnCode.string2MD5("uid=88988&sid=f57ed517-a915-4ae0-9d23-43d7628fee87&tryit=y&ts=1492420530");
//		System.out.println("2=MD5密文："+md5);
		System.out.println(decrypt("vjYB6tudKrs40Kd2d79v45DKqSNxgs8Yo2FIwuahoFc=", "uwuAEppE"));
	}
	/**
	 * 加密
	...
	public static String encrypt(String message, String key) {
		try {
			System.out.println("请求加密：原文="+message+"，秘钥="+key);
