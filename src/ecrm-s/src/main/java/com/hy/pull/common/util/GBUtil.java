...
public class GBUtil {
    ...
    public static String getEncryptedPassword(String password, String salt) throws Exception {  
        KeySpec spec = new PBEKeySpec(password.toCharArray(), org.apache.commons.codec.binary.Base64.decodeBase64(salt), PBKDF2_ITERATIONS, HASH_BIT_SIZE);  
    ...
    public static String encryptData(String data,String KEY,String IV){  
        try {  
            ...
            IvParameterSpec ivspec = new IvParameterSpec(fromHex(IV));  
		...
		public static void main(String[] args) throws Exception {
			String password = "280285";  
			String testData = "sid=ttps2322342341&tryit=y&ts=1492420530&ck=a3c8eacc15277e1e90834fc108906d30";
		    ...
		    System.out.println("BBBBBBB   KEY:  "+       key);
		    String iv = ciphertext.substring(32);
		    System.out.println("BBBBBBB    IV:  "+ iv);
			System.out.println("AES DATA:  "+GBUtil.encryptData(testData,key,iv));
		}
}
