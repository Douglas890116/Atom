...
public class DepositPlayerMoneyResponse  implements java.io.Serializable {
    private com.hy.pull.common.util.game.hb.MoneyResponse depositPlayerMoneyResult;

    public DepositPlayerMoneyResponse() {
    }

    public DepositPlayerMoneyResponse(
           com.hy.pull.common.util.game.hb.MoneyResponse depositPlayerMoneyResult) {
     ...
     */
    public com.hy.pull.common.util.game.hb.MoneyResponse getDepositPlayerMoneyResult() {
        return depositPlayerMoneyResult;
    }
     ...
     */
    public void setDepositPlayerMoneyResult(com.hy.pull.common.util.game.hb.MoneyResponse depositPlayerMoneyResult) {
        this.depositPlayerMoneyResult = depositPlayerMoneyResult;
    }
