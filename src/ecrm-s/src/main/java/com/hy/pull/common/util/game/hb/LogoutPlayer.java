...
public class LogoutPlayer  implements java.io.Serializable {
    private com.hy.pull.common.util.game.hb.LogoutPlayerRequest req;

    public LogoutPlayer() {
    }

    public LogoutPlayer(
           com.hy.pull.common.util.game.hb.LogoutPlayerRequest req) {
           this.req = req;
    }
     ...
     * @return req
     */
    public com.hy.pull.common.util.game.hb.LogoutPlayerRequest getReq() {
        return req;
    }
     ...
     * @param req
     */
    public void setReq(com.hy.pull.common.util.game.hb.LogoutPlayerRequest req) {
        this.req = req;
    }
