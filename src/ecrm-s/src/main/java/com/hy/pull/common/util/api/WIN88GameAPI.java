 ...
 * @author temdy
 */
public class WIN88GameAPI implements BaseInterface {
	
	private String API_URL = "https://kioskpublicapi.grandmandarin88.com";//公用
	private String FILE_URL = "";//公用
	private String KEY_STORE = "";//公用
	
	//测试
	private String FILE_URL_TEST = "C:/p12/play.p12";//公用
	private String KEY_STORE_TEST = "changeit";//公用
	//正式
	private String FILE_URL_RELEASE = "/data/p12/play.p12";//公用
	private String KEY_STORE_RELEASE = "changeit";//公用
	
	private String ENTITY_KEY = "f016b449979320537f12907723845839c406ce3d20f1d4add8ffc80d51af4ebcee38b623885efb9ff976de00f03018f85eaa6193f0133c3e317d220129bf1edd";//私有
	private String adminname = "HYEADMIN";//私有
	private String kioskname = "HYE";//私有
	 ...
	 */
	public WIN88GameAPI(String ENTITY_KEY, String adminname, String kioskname, boolean IS_RELEASE, String GAME_API_URL){
	 ...
	 */
	@Deprecated
	public WIN88GameAPI(String API_URL,String FILE_URL,String KEY_STORE,String ENTITY_KEY){
...
//				https://kioskpublicapi.grandmandarin88.com/player/create/playername/WTEST001/adminname/XXADMIN/kioskname/XX/custom02/WIN88ENTITY
				...
				url.append("/custom02/");
				url.append("WIN88ENTITY");//特别注意：固定值WIN88ENTITY
				url.append("/TrackingId/");
...
//				https://kioskpublicapi.grandmandarin88.com/player/withdraw/playername/WTEST001/amount/10/adminname/XXADMIN/externaltranid/82736at12 
...
//			https://kioskpublicapi.grandmandarin88.com/player/deposit/playername/WTEST001/amount/10/adminname/XXADMIN/externaltranid/123456578989  
		...
		try{
			...
			if(MapUtil.isNulls(entity, "playername,password,deviceType,playtype")){		
				...
				if( deviceType.equals("0")) {//PC
					url.append("/win88game/index?");
				} else {//H5
					url.append("/win88game/loginh5?");
				}
				url.append("username=").append(entity.get("playername")).append("&");
				url.append("password=").append(entity.get("password"));
...
//				Blackjack Pro    21点专业版 Table & Card Games psdbj  Blackjack Pro (psdbj)
	...
	public static void main(String[] a){
		WIN88GameAPI pt = new WIN88GameAPI();
		Map<String, Object> entity = new HashMap<String, Object>();
		entity.put("playername", "HYE"+RandomString.createRandomString(15));//#&*
		entity.put("password", "12345678");
		
//		entity.put("playername", "by8lilake222");//#&*
//		entity.put("password", "aaa111");
		
		
		System.out.println(pt.createAccount(entity));//playername,password
		
//		entity.put("playername", "TEST_Z8vfdJtxdCD372t");
		entity.put("amount", "1");
...
//		entity.put("playername", "TEST_Z8vfdJtxdCD372t");
//		entity.put("externaltransactionid", "dc60820b-a284-42db-aa71-183c35d6fbae");
//		System.out.println(pt.getOrder(entity));//
...
//		System.out.println(pt.login(entity));//deviceType,playtype
