...
public class OGGameAPI implements BaseInterface {
...
//	private String AGENT = "OGCNYHYI";
	...
	private String API_URL = "http://cashapi.673ing.com/cashapi/DoBusiness.aspx";
...
//	http://cashapi.dg20mu.com/cashapi/getdata.aspx?params=
	 ...
	 * @param KEY 密钥
	 */
	public OGGameAPI(String API_URL,String KEY,String AGENT, String GAME_API_URL){
...
//		10	The agent not exist
		...
		if(MapUtil.isNulls(entity, "username,password,gametype")){
			...
			if(!String.valueOf(entity.get("gametype")).equals("1") && //视讯
				!String.valueOf(entity.get("gametype")).equals("2") &&//体育
				!String.valueOf(entity.get("gametype")).equals("3") && //彩票
				!String.valueOf(entity.get("gametype")).equals("4") &&//电子游戏
				!String.valueOf(entity.get("gametype")).equals("11") &&//新平台(明升)
				!String.valueOf(entity.get("gametype")).equals("21") ) {//手机体育,og手机版（视当前代理号来区分）
				
				return Enum_MSG.参数错误.message("gametype参数只能专递1,2,3,4,11,21代码");
			}
			...
			param.append("$platformname=Oriental");
//			param.append(entity.get("platformname"));
			...
			//iframe请贵方技术设定这个部分再试试。iframe=2是https，1是用框架的http，0是没有用框架的http
//			param.append("$iframe=1");
	...
	public static void main(String[] arg){
		OGGameAPI og = new OGGameAPI();
		Map<String, Object> entity = new HashMap<String, Object>();
//		entity.put("username", "hylgfsd90@#&_*sdx212");
		entity.put("username", "hyl"+RandomString.createRandomString(17));//27
		entity.put("password", "1234567812345");
		entity.put("newpassword", "1234567812345");
