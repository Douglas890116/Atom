 ...
 *
 */
public class ValidateCodeNumber {
	// 图片的宽度。
	...
	public ValidateCodeNumber() {
	}



	public void createCode(int width, int height, int codeCount, int lineCount) {
		this.width = width;
		this.height = height;
...
//		ValidateCodeNumber vCode = new ValidateCodeNumber(120, 40, 5, 150);
//		try {
