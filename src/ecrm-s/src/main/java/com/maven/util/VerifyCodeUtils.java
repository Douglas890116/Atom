...
//		
		...
		g2.setColor(getRandColor(50, 160));//全局的字体颜色
		int fontSize = h-5;
...
//		int x = 0;
//		int y = 0;
//		Color c1 = getRandColor(1, 255);
//		Color c2 = getRandColor(1, 255);
		for(int i = 0; i < verifySize; i++){
			AffineTransform affine = new AffineTransform();
			affine.setToRotation(Math.PI / 4 * rand.nextDouble() * (rand.nextBoolean() ? 1 : -1), (w / verifySize) * i + fontSize/2, h/2);
			g2.setTransform(affine);
//			g2.setColor(getRandColor(50, 160));
//			g2.setColor(getRandColor(1, 255));
			g2.drawChars(chars, i, 1, ((w-10) / verifySize) * i + 5, h/2 + fontSize/2 - 10);
			
//			x = ((w-10) / verifySize) * i + 5;
//			y = h/2 + fontSize/2 - 10;
//			g2.setColor(c1);
//			g2.drawChars(chars, i, 1, ShiftEast(x, 3), ShiftSouth(y, 3));
//			g2.setColor(c2);
