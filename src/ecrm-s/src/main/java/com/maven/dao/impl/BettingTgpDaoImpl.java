...
@Repository
public class BettingTgpDaoImpl extends BaseDaoImpl<BettingTgp> implements BettingTgpDao {
	...
	public Map<String, Object> takeRecordCountMoney(Map<String, Object> object) throws Exception {
		return getSqlSession().selectOne("BettingTgp.takeRecordCountMoney", object);
	}
}
