...
@Repository
public interface DataHandleDao extends BaseDao<DataHandle>{
	 ...
	 * @throws Exception
	 */
	void addBetRecord(DataHandle betrecord) throws Exception;
	 ...
	 * @throws Exception
	 */
	void updateBetRecord(DataHandle betrecord) throws Exception;
