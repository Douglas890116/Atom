...
public class HROrderConfig {
    ...
    public HROrderConfig(String v_oid, String v_rcvname, String v_rcvaddr, String v_rcvtel, String v_goodsname, String v_goodsdescription, 
            String v_rcvpost, String v_qq, String v_amount, String v_ymd, String v_ordername, String v_bankno, String v_moneytype) {
            this.v_oid = v_oid;
