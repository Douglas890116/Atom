 ...
 *
 */
public class ZfWXPayMent<M extends ZfWXMerchantConfig,O extends ZfWXOrderConfig> implements PayInterface<M,O>{

	@Override
	public String save(ZfWXMerchantConfig merchant, ZfWXOrderConfig order) throws Exception {
		
		String requestUrl = ZfWXPaySignUtil.getRequestUrl(merchant, order);
	...
	@Override
	@Deprecated
	public String pay(ZfWXMerchantConfig merchant, ZfWXOrderConfig order) throws Exception {
		return "";
	}
	...
	public static void main(String[] args) throws Exception {
		...
		ZfWXMerchantConfig merchant = new ZfWXMerchantConfig();
		...
		merchant.setPayUrl("https://api.dinpay.com/gateway/api/scanpay");
		
		ZfWXOrderConfig  __yeeorder =  new ZfWXOrderConfig();
		...
		__yeeorder.setBankCode("weixin_scan");
