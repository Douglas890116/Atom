...
public class LfQQPayAppConstants {
	/*================================================== 报头参数 ==================================================*/
...
/*================================================== 业务参数 ==================================================*/
	public static final String p2_service = "service";// 32	否	支付宝支付:qq_pay
	...
	public static final String p2_qq_pay_type = "qq_pay_type";// 10	否	支付宝扫码:qq_sm
...
/*================================================== 响应业务 ==================================================*/
	public static final String r2_qq_pay_sm_url = "qq_pay_sm_url";// 1024	否	支付宝支付唤醒URL
	public static final String r2_base64QRCode = "base64QRCode";// 2048	可	支付宝支付二维码图片(优先使用该返回，如果不存在则使用qq_pay_sm_url)
