...
public class ZfMerchantConfig {
	...
	public ZfMerchantConfig() {
		super();
		// TODO Auto-generated constructor stub
	}


	public ZfMerchantConfig(String payUrl, String merNo, String merKey, String merPubKey, String pubKey, String md5Key,
			String notiUrl) {
		super();
		this.payUrl = payUrl;
		this.merNo = merNo;
