...
public class NfWXPaySignUtil {

	
	public static String getRequestUrl(NfWXMerchantConfig merchant, NfWXOrderConfig order) {
		
//		组合签名数据的格式：
		
//		version=v1&partnerId=0755000001&orderId=5435345&goods=amF2YbPM0PLJ6LzG0+/R1A==&amount=100.00&expTime=&notifyUrl=https://wap.partner.com/notify.jsp&pageUrl=https://wap.partner.com/page.jsp&reserve=sid&
//		extendInfo=13590492970|00001&payMode=09&bankId=WECHAT&creditType=3&key=12348314-9388-11de-b73f-0f19974d6b20
		...
		System.out.println("获取二维码地址="+url);
...
//			partnerId=200909091234&orderId=5435345&amount=100.00&result=S&payTime=20090909081030&traceId=12345678&reserve=sid&creditType=2&key=TEST12345678TEST
	...
	public static void main(String[] args) {
		try {
			String url = "https://payhy.zcyzwl.top/servlet/InitBankLogoServlet";
			String partnerId = "755000089";
//			WEBPAY:表示获取支持WEB网站的银行列表
//			WAPPAY:表示获取支持手机网站的银行列表
			String channel = "WEBPAY";
			String rstType = "json";
			String key = "b17a98e4-24e2-11e7-ac95-5bb4754f3d40";
