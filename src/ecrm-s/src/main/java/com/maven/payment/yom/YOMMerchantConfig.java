 ...
 *
 */
public class YOMMerchantConfig {
	...
	public YOMMerchantConfig(String payUrl, String merNo, String merKey, String notiUrl, String returnUrl,
			String refererUrl) {
		super();
		this.payUrl = payUrl;
		this.merNo = merNo;
