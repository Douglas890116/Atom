 ...
 *
 */
public class ZfWXMerchantConfig {
	...
	public ZfWXMerchantConfig() {
		super();
		// TODO Auto-generated constructor stub
	}


	public ZfWXMerchantConfig(String payUrl, String merNo, String merKey, String merPubKey, String pubKey, String md5Key,
			String notiUrl) {
		super();
		this.payUrl = payUrl;
		this.merNo = merNo;
