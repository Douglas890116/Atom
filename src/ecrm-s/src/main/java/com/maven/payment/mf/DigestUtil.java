...
public class DigestUtil {
	...
	public static void main(String[] args) {
		System.out.println(hmacSign("Buy529F4F972736E5470382E0EA1A9F3EDE621.00CNYcommodityNamecommodityCategorycommodityDescriptionhttp://api.hyzonghe.net/apiCMBCHINA-NET-B2C1", "KrOKsdJVHl0yi04JPNoIHJ90K4B1aHVo"));
