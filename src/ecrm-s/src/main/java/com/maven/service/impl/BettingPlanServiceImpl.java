...
@Service
public class BettingPlanServiceImpl extends BaseServiceImpl<BettingAllPlan> implements BettingPlanService{

	@Autowired
	private BettingPlanDao BettingAllDayDao;
	@Autowired
	...
	@Override
	public BaseDao<BettingAllPlan> baseDao() {
		return BettingAllDayDao;
	}

	@Override
	public Class<BettingAllPlan> getClazz() {
		return BettingAllPlan.class;
	}
	 ...
	 */
	@Override
	public void updateByPrimary(BettingAllPlan bettingAllDay) throws Exception {
	 ...
	 */
	@Override
	public List<BettingAllPlan> selectForPage(Map<String, Object> paramObj) throws Exception {
	 ...
	 */
	@Override
	public List<BettingAllPlan> select(Map<String, Object> paramObj) throws Exception {
	 ...
	 */
	@Override
	public BettingAllPlan selectByPrimary(String lsh) throws Exception {
		return this.BettingAllDayDao.selectByPrimary(lsh);
	}
