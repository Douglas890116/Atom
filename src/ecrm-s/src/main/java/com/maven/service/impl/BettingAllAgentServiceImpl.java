...
@Service
public class BettingAllAgentServiceImpl extends BaseServiceImpl<BettingAllAgent> implements BettingAllAgentService{

	@Autowired
	private BettingAllAgentDao BettingAllDayDao;
	
	@Override
	public BaseDao<BettingAllAgent> baseDao() {
		return BettingAllDayDao;
	}

	@Override
	public Class<BettingAllAgent> getClazz() {
		return BettingAllAgent.class;
	}
	 ...
	 */
	@Override
	public void updateByPrimary(BettingAllAgent bettingAllDay) throws Exception {
	 ...
	 */
	@Override
	public List<BettingAllAgent> selectForPage(Map<String, Object> paramObj) throws Exception {
	 ...
	 */
	@Override
	public List<BettingAllAgent> select(Map<String, Object> paramObj) throws Exception {
