...
@Service
public class BettingIdnServiceImpl extends BaseServiceImpl<BettingIdn> implements BettingGameService<BettingIdn> {
	
	@Autowired
	private BettingIdnDao bettingHqNhqDaoImpl;

	@Override
	public BaseDao<BettingIdn> baseDao() {
		return bettingHqNhqDaoImpl;
	}

	@Override
	public Class<BettingIdn> getClazz() {
		return BettingIdn.class;
	}

	@Override
	public List<BettingIdn> takeRecord(Map<String, Object> object) throws Exception {
