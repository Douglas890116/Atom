...
public class BettingAllMember {
    ...
    public BettingAllMember() {
		super();
	}
    public BettingAllMember(String enterprisecode, String brandcode, String employeecode, String parentemployeecode,
